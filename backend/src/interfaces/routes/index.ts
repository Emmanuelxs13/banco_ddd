...
export function createRouter(
  ...
  router.get('/clientes/persona/:id', authMiddleware, clientePersonaCtrl.getById);
  ...
  router.get('/clientes/empresa/:id', authMiddleware, clienteEmpresaCtrl.getById);
  ...
  router.post('/prestamos/:id/desembolsar', authMiddleware, prestamoCtrl.desembolsar);
  ...
  router.put('/transferencias/:id/resolver', authMiddleware, transferenciaCtrl.resolver);
  router.post('/transferencias/vencer', authMiddleware, transferenciaCtrl.vencer);
